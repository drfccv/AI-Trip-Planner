...
test("MCP discovery has an overall timeout", () => { const source = readFileSync(new URL("../lib/ai/planner.ts", import.meta.url), "utf8"); assert.match(source, /MCP_DISCOVERY_TIMEOUT/); assert.match(source, /15000/); });
