...
declare global{interface Window{tripPlanner?:{request(input:{path:string;method:string;body?:unknown}):Promise<{status:number;data:unknown}>;windowControls?:DesktopWindowControls}}}
